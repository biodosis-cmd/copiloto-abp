...
export function ProblemSlide({ data }) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full p-12 items-center">
            {/* Left: The Problem */}
            <motion.div
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6 }}
                className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-slate-100 h-full flex flex-col justify-center relative overflow-hidden"
            >
            ...
            <motion.div
                ...
                className="bg-indigo-600 text-white p-8 rounded-3xl shadow-2xl shadow-indigo-200 h-full flex flex-col justify-center relative overflow-hidden"
            >
